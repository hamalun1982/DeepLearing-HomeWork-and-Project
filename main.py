...
from model import train_function, train_function_with_autoencoder
...
images_part2 = np.load('/work/cse496dl/shared/homework/02/imagenet_images.npy')
    ...
    for b in batchsize:
        for l in learningrate:
            for r in regularization:
                train_accuracy, validation_accuracy = train_function_with_autoencoder(train_images,train_labels,val_images,val_labels,test_images, test_labels, images_part2,r, l, b, h)
